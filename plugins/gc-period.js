...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x515443("> *🔔 Group Chat Automatically Unlocked By Princess Raya*");
    }, _0x57d309);
...
cmd({
  ...
  try {
    ...
    setTimeout(() => {
      ...
      _0x5c514e("> *🔕 Group Chat automatically locked by Princess Raya*");
    }, _0x4b2fe4);
...
cmd({
  ...
  try {
    ...
    const _0x23264b = await _0x188ee4.sendMessage(_0x5a0744.chat, {
      'text': "*GROUP CHAT MUTED BY PRINCESS RAYA* 🔒"
    }, {
      'quoted': _0x2926d7
    });
...
cmd({
  ...
  try {
    ...
    const _0x74b371 = await _0x298fe1.sendMessage(_0x2602ac.chat, {
      'text': "*GROUP CHAT UNMUTED BY PRINCESS RAYA* 🔒"
    }, {
      'quoted': _0x116d41
    });
